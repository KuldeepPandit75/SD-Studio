  ...
  return (
    <>
      ...
      >
        <video
          src="/videos/arch.mp4"
          className="absolute inset-0 w-full h-full object-cover z-0 pointer-events-none scale-130 object-top"
          loop
          muted
          autoPlay
        />
          ...
          {services.map((service, idx) => (
            ...
            >
              <div className="h-[400px] w-[350px] p-5  flex flex-col items-end justify-between ">
                <div
                  className="bg-center bg-cover h-[50%] flex justify-center items-center rounded-[12px] w-full"
                  style={{
                    backgroundImage: `linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)), url(${service.img})`,
                  }}
                >
                  <p
                    className="text-center font-avant font-bold text-2xl"
                    style={{ color: secondaryColor }}
                  >
                    {service.name}
                  </p>
                ...
                <p
                  className="font-avant -mt-[20px]"
                  style={{ color: secondaryColor }}
                >
                  {service.des}
                </p>
                <button
                  className="font-avant font-bold px-4 py-1 rounded-lg"
                  style={{
